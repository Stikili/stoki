    ...
    <div className="max-w-2xl mx-auto px-6 py-12" style={{ color: 'var(--foreground)' }}>
      ...
      <div className="space-y-6 text-sm leading-relaxed" style={{ color: 'var(--foreground)' }}>
        <section>
          ...
          <p className="mt-2">
            Contact: <a href="mailto:support@stokiapp.com" className="text-brand underline">support@stokiapp.com</a>
          </p>
        </section>
        ...
        <section>
          ...
          <p>You have the following rights, exercisable free of charge by emailing <a href="mailto:support@stokiapp.com" className="text-brand underline">support@stokiapp.com</a>:</p>
          <ul className="list-disc ml-5 space-y-1 mt-2">
        ...
        <section>
          ...
          <p>
            Our Information Officer can be reached at <a href="mailto:support@stokiapp.com" className="text-brand underline">support@stokiapp.com</a>.
