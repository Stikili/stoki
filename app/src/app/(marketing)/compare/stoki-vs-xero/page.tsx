...
const data: ComparisonPageData = {
  ...
  tldr: [
    ...
    'Stoki wins for owner-run SMMEs that want one app for the whole business — POS, credit book, VAT201, PAYE, invoicing, AI advisor, WhatsApp bot — at roughly one-third the price.',
  ...
  rows: [
    { feature: 'Entry price (ZAR)', competitor: '~R305/mo (Starter)', stoki: 'Free forever for first store', winner: 'stoki' },
    { feature: 'Mid tier price (ZAR)', competitor: '~R515/mo (Standard)', stoki: 'Pro tier — priced under Xero Starter', winner: 'stoki' },
    ...
    { feature: 'Inventory', competitor: 'Basic (Standard plan and above)', stoki: 'Full — categories, wastage, expiry, stocktake, POs', winner: 'stoki' },
  ...
  chooseStoki: [
    ...
    'Your budget is R99-299/month, not R305-1,500/month.',
  ...
  pricingIntro:
    'Xero prices in ZAR but is a global product; Stoki is priced for SA SMMEs first. Roughly one-third of the cost at each tier.',
  pricingBullets: [
    { label: 'Xero Starter', body: 'around R305/mo — limited to 20 invoices/mo, 5 bills, 1 user. Bank reconciliation included.' },
    { label: 'Xero Standard', body: 'around R515/mo — unlimited invoices, bills, and users. SA payroll requires SimplePay add-on (extra).' },
    { label: 'Xero Premium', body: 'around R840/mo — multi-currency added; still needs SimplePay for SA payroll.' },
    { label: 'Stoki Free', body: 'free forever for your first store — POS, inventory, credit book, VAT201 export, basic reports.' },
    { label: 'Stoki Pro', body: 'monthly ZAR subscription (well under Xero Starter). Payroll, invoicing, unlimited users, AI advisor, multi-store, WhatsApp bot.' },
  ],
  faqs: [
    { q: 'Is Stoki a Xero alternative for South Africa?', a: 'Yes — for owner-run SMMEs. Stoki is designed to replace Xero for South African small businesses that don\'t need formal double-entry accounting or an accountant-managed workflow. It\'s cheaper, includes POS + payroll + credit book natively (Xero doesn\'t), and adds a WhatsApp bot + AI advisor Xero doesn\'t have. If your accountant runs everything and prefers Xero, keep Xero. If you run the books yourself, Stoki is likely a better fit at one-third the cost.' },
    ...
    { q: 'What\'s the price difference between Stoki and Xero?', a: 'Roughly 3-4x. Xero Starter is around R305/mo; Stoki\'s Pro tier is well under half that. Xero Standard is around R515/mo; Stoki\'s Business tier is around a third of that. Stoki Free covers what Xero Starter offers for zero cost. Note: Xero pricing may change; check xero.com/za for their current SA pricing.' },
