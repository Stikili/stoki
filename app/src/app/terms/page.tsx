      ...
      <div className="space-y-6 text-sm leading-relaxed" style={{ color: 'var(--foreground)' }}>
        ...
        <section>
          ...
          <p>
            ...
            contact us at <a href="mailto:hello@stoki.app" className="text-brand underline">hello@stoki.app</a>{' '}
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:hello@stoki.app" className="text-brand underline">hello@stoki.app</a>.
          </p>
        </section>
      </div>
