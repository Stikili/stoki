...
const INTRO: Message = {
  role: 'assistant',
  content:
    "Howzit — I'm stoki. Ask me about your stock, sales, customers, or what's happening with prices and the economy. Tap a question below to start, or just type yours.",
}
