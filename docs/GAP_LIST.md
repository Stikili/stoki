...
**2026-08-30:**
- **LinkedIn post #5 published** — the August cost report, led on "diesel now costs more than petrol". First post generated by a repeatable process rather than a one-off draft. 17 days after post #4, which breaks the prior ~8-9 day rhythm — see the cadence note below
...
| # | Item | Where |
|---|---|---|
| 8 | **LinkedIn cadence — cost report alone is monthly** | Post #5 (2026-08-30) came 17 days after #4, because it waited on the blog. The cost report guarantees **one post a month**, which is slower than the ~8-9 day rhythm of posts #1-4. If ~monthly is fine, nothing to do — the routine covers it. If not, a second recurring format is needed (a guide per month, or a short product-update post) to fill the gap between cost reports. **Decision needed, not a task.** |
